...
{
    self.backgroundColor = [SCIBnsepectableManager colorWithRGBHexString:hexRGBColor];
}
...
{
    self.layer.borderColor = [SCIBnsepectableManager colorWithRGBHexString:borderHexRGBColor].CGColor;
}
...
//{
//    self.layer.shadowColor = [SCIBnsepectableManager colorWithRGBHexString:shadowHexRGBColor].CGColor;
//}
//
