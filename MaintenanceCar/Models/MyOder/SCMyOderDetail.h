...
@protocol SCMyOderDetailProgress
@end

@interface SCMyOderDetailProgress : JSONModel
...
@interface SCMyOderDetail : SCOder
...
@property (nonatomic, strong) NSArray <SCMyOderDetailProgress>*processes;
