...
@property (nonatomic, strong) NSString *entityName;                   // CoreData实体名
@property (nonatomic, strong) NSString *momdName;                     // CoreData数据文件名
@property (nonatomic, strong) NSString *sqliteName;                   // SQLite数据库文件名
