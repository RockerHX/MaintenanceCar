...
#define IS_WIDESCREEN_5_PRIOR               (fabs((double)[[UIScreen mainScreen] bounds].size.height - (double)480) < __DBL_EPSILON__)
...
#define IS_IPHONE_5_PRIOR                   (IS_IPHONE && IS_WIDESCREEN_5_PRIOR)
